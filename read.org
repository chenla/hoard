...
** 2012 - The Clash of the Cultures: Investment vs. Speculation
 :PROPERTIES:
  ...
  :INTERLEAVE_PDF: ./lib/bogle:2012clash.pdf
:END:
...
** 2017 - Walkaway. A novel
 :PROPERTIES:
  :Custom_ID: doctorow:2017walkaway
  ...
  :INTERLEAVE_PDF: ./lib/doctorow:2017walkaway.pdf
:END:

Citation: cite:doctorow:2017walkaway
...
instead of sharing is like smearing yourself with shit:
gross. Wrong. Our winning doesn't mean you don't get to be greedy. It
means people will be ashamed for you, will pity you and want to
distance themselves from you. You can be as greedy as you want, but no
one will admire you for it.
#+end_quote

** 2009 - The Origin of Concepts
 :PROPERTIES:
  :Custom_ID: carey:2009origin
  :AUTHOR: Susan Carey
  :JOURNAL: 
  :YEAR: 2009
  :VOLUME: 
  ...
  :INTERLEAVE_PDF: ./lib/carey:2009origin.pdf
:END:

cite:carey:2009origin

Book was cited in Pinker cite:pinker:2018enlightenment about innate
...
*** Notes for page 458
:PROPERTIES:
:interleave_page_note: 458
:END:

#+begin_quote
A full account of the origin of human concepts must appeal to three
different time scales and three different types of processes. Over
millions of years, evolutionary processes create innate
representational capacities.  Over hundreds of years, learning
processes in a cultural-historical context create new representational
resources that, in turn, are expressed and maintained in language and
in the cultural products they make possible.  And then, over years,
each child must transcend the innately given representational
capacities by mastering the culturally constructed ones.
#+end_quote
